...
Si en vez de GitHub quieres repetir la build local en Windows, usa la guia de [docs/android_local_build.md](android_local_build.md).

## Objetivo

Construir la app `maxgesth field work` en remoto y descargar un APK instalable en Android.

## Estado operativo actual

La build remota esta pendiente porque la cuota mensual de GitHub Actions esta
superada. Mientras dure ese bloqueo, no interpretar la ausencia de build como
fallo tecnico del workflow.

Alternativas temporales:

- usar [docs/android_local_build.md](android_local_build.md) para validar APK en
  Windows;
- dejar la validacion remota explicitamente pendiente en el cierre de tarea;
- relanzar GitHub Actions cuando vuelva la cuota.
