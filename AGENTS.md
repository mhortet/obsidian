...
| Proyectos | `30 - Proyectos/` | Trabajo vivo con entregables, decisiones y continuidad. |
| Programacion | `32 - programacion/` | Aprendizaje, patrones y notas tecnicas de desarrollo. |
