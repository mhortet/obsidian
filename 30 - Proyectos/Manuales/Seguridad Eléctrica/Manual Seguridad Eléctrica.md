...
Los equipos Clase I basan su protección en dos elementos fundamentales:
...
En condiciones normales, las partes metálicas accesibles no presentan tensión peligrosa.

Si se produce un fallo del aislamiento básico, la corriente de defecto circula hacia tierra a través del conductor de protección, evitando que la carcasa alcance un potencial peligroso.

Esta filosofía hace que la integridad de la conexión a tierra sea un elemento crítico para la seguridad.

### Características principales

- Disponen de conductor de protección (PE).
    
- Utilizan enchufes con toma de tierra.
    
- Requieren verificación periódica de continuidad de tierra.
    
- Son la clase más habitual en equipos de gran tamaño.
    

### Ejemplos habituales

- Ecógrafos de consola.
...
## 7.3 Equipos Clase II

Los equipos Clase II no dependen de una conexión a tierra para garantizar la seguridad.

Su protección se basa en la utilización de doble aislamiento o aislamiento reforzado.

En caso de fallo de una de las barreras aislantes, continúa existiendo una segunda protección independiente.

### Características principales

- No utilizan conductor de protección.
    
- No requieren toma de tierra funcional para la seguridad.
    
- Incorporan doble aislamiento.
    
- Presentan menor dependencia de la instalación eléctrica.
    

### Identificación

Normalmente incorporan el símbolo de doble cuadrado.

### Ejemplos habituales

- Algunos equipos portátiles.
    
- Determinados cargadores médicos.
    
- Equipos alimentados mediante adaptadores externos específicos.
    
- Algunos ecógrafos portátiles alimentados por batería.
    

---

## 7.4 Equipos con Alimentación Interna

Determinados equipos funcionan exclusivamente mediante baterías o acumuladores internos durante su uso clínico.

En estas condiciones, quedan aislados de la red eléctrica y presentan riesgos significativamente menores asociados a defectos de alimentación.

No obstante, cuando se conectan a la red para su carga o alimentación, deben cumplir igualmente los requisitos de seguridad establecidos por las normas aplicables.
...
- Ecógrafos ultraportátiles.
    

---

## 7.5 Comparación entre Clases de Protección

|Característica|Clase I|Clase II|
|---|---|---|
|Toma de tierra|Sí|No|
|Aislamiento básico|Sí|Sí|
|Aislamiento suplementario|No necesariamente|Sí|
|Dependencia del PE|Alta|Nula|
|Ensayo de tierra|Obligatorio|No aplicable|
|Uso hospitalario|Muy frecuente|Frecuente|

---

## 7.6 Implicaciones para el Técnico

La identificación incorrecta de la clase de protección puede conducir a errores durante las verificaciones.

Por ejemplo:

- Intentar medir continuidad de tierra en un equipo Clase II carece de sentido técnico.
    
- Interpretar una ausencia de conductor PE como un defecto puede ser incorrecto.
    
- Aplicar límites inadecuados puede generar conclusiones erróneas.
    

Por este motivo, la identificación de la clase de protección debe realizarse siempre antes de iniciar cualquier ensayo de seguridad eléctrica.

---

## 7.7 Conclusiones

La clasificación por protección eléctrica permite comprender cómo ha sido diseñado un equipo para proteger a pacientes y operadores frente al riesgo eléctrico.

La correcta identificación de la clase de protección constituye el primer paso para seleccionar adecuadamente los ensayos y criterios de aceptación aplicables.
...
La realización de ensayos de seguridad eléctrica debe seguir una secuencia lógica y repetible que garantice la fiabilidad de los resultados obtenidos.

La experiencia demuestra que muchos errores no se producen durante la medición, sino durante la preparación previa o la interpretación posterior.

Por este motivo, resulta recomendable seguir siempre una metodología estructurada.

---

## 14.2 Preparación de la Intervención

Antes de iniciar cualquier ensayo deberá verificarse:

- Identificación del equipo.    
- Estado de calibración del analizador.    
- Disponibilidad de accesorios necesarios.    
- Existencia de procedimientos específicos del fabricante.    
- Condiciones de seguridad del entorno.    

Siempre que sea posible, deberán revisarse los informes anteriores para conocer el comportamiento histórico del equipo.

---

## 14.3 Recopilación de Información

Antes de conectar el analizador es recomendable obtener:
...
Esta información condicionará tanto los ensayos a realizar como los límites aplicables.

---

## 14.4 Inspección Visual

La inspección visual constituye siempre el primer ensayo.
...
La detección de defectos graves puede justificar la suspensión inmediata del procedimiento.

---

## 14.5 Selección de los Ensayos

Los ensayos deberán seleccionarse en función de:

- Clase I o Clase II.    
- Presencia de partes aplicadas.    
- BF o CF.    
- Procedimiento interno.
- Recomendaciones del fabricante.    

No todos los equipos requieren exactamente las mismas pruebas.

---

## 14.6 Secuencia Recomendada

Como criterio general puede utilizarse la siguiente secuencia:

1. Inspección visual.    
2. Continuidad de tierra (Clase I).    
3. Resistencia de aislamiento.    
4. Corrientes de fuga.    
5. Verificaciones funcionales.    
6. Registro de resultados.    

La secuencia puede modificarse cuando las características del equipo así lo requieran.

---

## 14.7 Verificación Funcional

Los ensayos de seguridad eléctrica deben complementarse con una comprobación funcional básica.

Un equipo eléctricamente seguro pero incapaz de realizar su función clínica sigue siendo un equipo no apto para el servicio.

La profundidad de esta verificación dependerá de:
...
## 14.8 Registro de Resultados

Todos los valores obtenidos deben registrarse.

Siempre que sea posible se recomienda conservar:
...
La trazabilidad constituye una parte esencial del mantenimiento preventivo.

---

## 14.9 Criterios de Finalización

La intervención podrá considerarse finalizada cuando:

- Se hayan completado todos los ensayos previstos.    
- Los resultados hayan sido documentados.    
- Se hayan evaluado las desviaciones encontradas.    
- El estado final del equipo haya sido determinado.    

---

## 14.10 Conclusiones

La aplicación de una metodología sistemática mejora la calidad de las verificaciones y reduce la probabilidad de errores durante el proceso de evaluación.
...
La obtención de un valor de medida constituye únicamente una parte del proceso de evaluación.

La verdadera labor del técnico comienza cuando debe determinar qué significado tiene dicho resultado y qué implicaciones presenta para la seguridad y utilización del equipo.

Interpretar no consiste únicamente en comparar un número con un límite establecido por una norma.

Interpretar consiste en comprender qué está indicando el comportamiento eléctrico del equipo.

---

## 15.2 Resultado Conforme

Un resultado conforme indica que el parámetro evaluado se encuentra dentro de los límites establecidos.

Sin embargo, un resultado conforme no implica necesariamente que el equipo se encuentre en perfecto estado.

Por ejemplo:

- Una corriente de fuga puede cumplir el límite y haber aumentado significativamente respecto a años anteriores.    
- Una resistencia de aislamiento puede cumplir la norma y mostrar una tendencia descendente preocupante.    

La conformidad debe interpretarse dentro del contexto global del equipo.

---

## 15.3 Resultado No Conforme

Un resultado no conforme requiere una investigación técnica.

Antes de concluir que existe un defecto real deben evaluarse posibles causas como:

- Errores de conexión.    
- Método incorrecto.    
- Accesorios conectados.    
- Condiciones ambientales.    
- Influencia de otros equipos.    

La repetición controlada de la medida suele ser recomendable antes de emitir conclusiones definitivas.

---

## 15.4 La Importancia del Histórico

El histórico de medidas constituye una de las herramientas más potentes de las que dispone un servicio de electromedicina.

Una revisión aislada proporciona una fotografía.
Una serie histórica permite observar la evolución del equipo.
En muchos casos, las tendencias son más valiosas que los propios valores absolutos.

---

## 15.5 Tendencias de Degradación

Algunos ejemplos:

### Aumento progresivo de fuga

Posibles causas:
- Humedad.    
- Envejecimiento de filtros.    
- Degradación del aislamiento.    

### Descenso progresivo del aislamiento
...
### Incremento de resistencia de tierra
...
La detección temprana permite actuar antes de que aparezca un fallo clínico o de seguridad.

---

## 15.6 Resultados que Merecen Atención Aunque Cumplan

Uno de los errores más frecuentes consiste en asumir que todo resultado conforme es automáticamente satisfactorio.

Existen situaciones que justifican seguimiento específico:

- Valores próximos al límite.    
- Cambios bruscos respecto a revisiones anteriores.    
- Diferencias significativas entre equipos idénticos.    
- Comportamientos inestables.    

Estos casos pueden indicar el inicio de un proceso de degradación.

---

## 15.7 Resultados que Parecen Malos y No lo Son

La experiencia permite identificar situaciones aparentemente anómalas que no representan un defecto real.

Ejemplos:

- Corrientes de fuga elevadas asociadas a filtros EMI.    
- Diferencias entre métodos de medición.    
- Equipos con características constructivas especiales.    

Por este motivo, el conocimiento del equipo resulta tan importante como la propia medición.

---

## 15.8 Correlación entre Ensayos

Los ensayos nunca deben interpretarse de forma aislada.

Por ejemplo:

- Una fuga elevada acompañada de aislamiento reducido refuerza la sospecha de deterioro.    
- Una fuga elevada con aislamiento correcto puede indicar influencia de filtros EMI.    
- Una continuidad de tierra deficiente junto con daños visibles aumenta significativamente el nivel de riesgo.    

La interpretación conjunta proporciona una visión mucho más fiable.

---

## 15.9 Juicio Técnico

La normativa proporciona límites y procedimientos.

**Sin embargo, la decisión final sigue dependiendo del criterio profesional del técnico responsable.

La experiencia, el conocimiento del equipo y el análisis global de la situación continúan siendo elementos fundamentales de la evaluación.

---

## 15.10 Conclusiones

La interpretación técnica constituye el paso que transforma una medición en una evaluación de seguridad.

El objetivo del técnico no consiste únicamente en medir, sino en comprender qué indican los resultados obtenidos y cómo afectan a la seguridad del paciente y del operador.
---
