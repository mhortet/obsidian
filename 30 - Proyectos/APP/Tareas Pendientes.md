...
- [ ] Exportación PDF.
- [ ] Estadísticas.
- [ ] Lanzar informes con selección si  Dashboard o impreso en formato pdf o word para su edición manual con graficas y tablas con datos de preventivos realizados según periodos, preventivos Ok, Incidencias No conformidades, etc. 
